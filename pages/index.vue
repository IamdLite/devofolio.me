<script setup>
  definePageMeta({
    title: "Esdras Fopa",
    description:
      "Esdras Fopa passes your organisation's cyberspace through fire to generate actionable insights for a resilient security infrastructure.",
  });

  useHead({
    titleTemplate: "Esdras Fopa",
  });
  ...
  const skillset = ref({
    essentials: ["C2 Servers", "OWASP", "Active Directory", "Linux, AWS", "Malware", "Networking", "Python, C, System Verilog, Java", "IDM Suite, ARCADIA with Capella"],
    tinker: ["Hardware Security", "Nanosatellite Mission Design", "Low TRL Space Technologies", "Social & Reverse Engineering"],
  });
  ...
  <article class="[&>*]:my-4 first:[&>*]:mt-0 [&>hr]:my-6 md:[&>hr]:my-10">
    ...
    <section>
      ...
      <p class="mb-4 text-xl font-medium text-zinc-700 dark:text-zinc-300">
        Beyond CTFs, I have experience performing
        <span class="highlight">Red Team operations</span> against
        <span class="highlight">hardened</span> infrastructures. I am a NASA Certified
        <span class="highlight">open science</span> researcher, and a
        <span class="highlight">devSecOps</span> enthusiast.
      </p>
    ...
    <section class="mb-2 space-y-2">
      ...
      >
        ...
        >
          ...
          >
            <p class="text-lg font-bold">Want to learn how to hack ?</p>
            <nuxt-link
              class="px-4 py-2 bg-blue-500 rounded-lg focus-visible:outline-none text-zinc-800"
              to="https://t.me/endOfilebitsociety"
              id="contact-btn"
              >Go for it!</nuxt-link
            >
          </div>
        ...
        <app-link-card
          ...
          url="https://orcid.org/0009-0003-6958-9159/"
        ></app-link-card>
        <app-link-card
          label="Let's connect !"
          icon="fluent-emoji:sparkles"
          :is-external-url="true"
          url="https://linktr.ee/iamdlite"
        ></app-link-card>
        <app-link-card
          label="My Resume"
        ...
        <app-link-card
          ...
          :is-external-url="true"
          url="https://tryhackme.com/r/p/iamdlite#"
        ></app-link-card>
      </div>
    </section>
    <app-divider class="md:my-6" />
    ...
    <section>
      ...
      <p class="mb-3 text-zinc-700 dark:text-zinc-300">
        I am a <span class="subtle-highlight">craftsman</span>,
        and here are some of my tools:
      </p>
      <ul
      ...
      <p class="mb-3 text-zinc-700 dark:text-zinc-300">
        I'm 
        <span class="subtle-highlight">always in the loop</span> regarding:
      </p>
      <ul
    ...
    <section>
      ...
      <p class="mb-4 text-zinc-700 dark:text-zinc-300">
        As you would expect, I work on personal and academic projects to build my portfolio. You can find the ones that I somehow managed to complete here. 
      </p>
    ...
    <section>
      ...
      <p class="mb-4 text-zinc-700 dark:text-zinc-300">
        I consolidate my learning process by sharing the substance of materials that taught me so that you can grasp it faster. I write to share cool tech and my journey.
      </p>
