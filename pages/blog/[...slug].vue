<script setup>
    ...
    useHead({
      titleTemplate: "%s | Blog · Esdras Fopa",
    });
    ...
    const data = {
      title: 'Create',
      description: 'bla',
      image: 'https://esdrasfopa.dev/assets/images/og-image.png'
  }
    const serverMeta = {
      ogType: "article",
      ogLocale: "en_US",
      twitterCard: "summary",
      twitterCreator: "@iamdlite",
    };

    useSeoMeta({
      title: () => postTitle,
      description: () => postDescription,
      ogTitle: () => `${postTitle} | Blog · Esdras Fopa`,
      twitterTitle: () => `${postTitle} | Blog · Esdras Fopa`,
      ogDescription: () => postDescription,
      twitterDescription: () => postDescription,
      ogImage: () => postCover,
      twitterImage: () => postCover,
      ogUrl: () => `https://esdrasfopa.dev${route.path}`,
      ...serverMeta,
    });
</script>
